/* 
	...
	Hardware: SparkFun ESP32 Thing Plus(esp32_esp32thing_plus), Platform=esp32, Package=esp32
*/
...
#define ARDUINO_ESP32_THING_PLUS 1
#define ARDUINO_ARCH_ESP32 1
#define ARDUINO_BOARD "ESP32_THING_PLUS"
#define ARDUINO_VARIANT "esp32thing_plus"
